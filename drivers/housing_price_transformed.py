...
with ln.tracking("housing_price"):
    ...
    ln.call(
        ...
        text="alt.data_transformers.enable('json')",
        line_no=6,
    )
    ln.call(
        alt.renderers.enable("mimetype"),
        text="alt.renderers.enable('mimetype')",
        line_no=7,
    )

    dbf = ln.call(
        dbfread.DBF(
            "../../tracer/property_example/L3_SHP_M114_Greenfield/M114Assess_CY20_FY20.dbf"
        ),
    ...
    x = ln.assign(
        ...
        text="assets[['BLDG_VAL', 'LOT_SIZE', 'NUM_ROOMS']]",
        line_no=18,
        target="x",
    )
